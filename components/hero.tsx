...
const Hero = () => {
  return (
    <section className='mx-0 md:mx-10 bg-gradient-to-r from-sky-100 to-violet-100 md:rounded-2xl w-full'>
      <Reveal keyframes={fadeInBottom} triggerOnce={true}>
        <div className='mt-20 md:mt-40 relative text-center'>
          <h1 className='font-bold text-5xl md:text-7xl mb-10 text-slate-900'>Product docs <br></br>that <span className='font-extrabold underline decoration-wavy decoration-blue-500'>save you time</span></h1>
