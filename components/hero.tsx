...
const Hero = () => {
  return (
    <section className='mx-0 md:mx-10 sm:mx-5 bg-sky-100 sm:rounded-2xl w-full relative mt-4'>
      <Reveal keyframes={fadeInBottom} triggerOnce={true}>
        <div className='mt-24 text-center'>
          <h1 className='font-bold text-5xl md:text-7xl text-slate-900 mb-10'>Product docs <br></br>that <span className='font-extrabold underline decoration-wavy text-sky-500'>save you time</span></h1>
          ...
          <button className="text-lg font-bold bg-blue-600 text-white rounded-2xl px-10 py-3 mb-2">Start generating docs</button>
