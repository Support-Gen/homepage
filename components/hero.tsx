    ...
    <section className='mx-0 md:mx-10 sm:mx-5 bg-indigo-100 sm:rounded-3xl w-full relative mt-4'>
      <Reveal keyframes={fadeInBottom} triggerOnce={true}>
        <div className='mt-24 text-center'>
          ...
          <button className="text-lg font-medium bg-violet-600 hover:bg-violet-500 text-white rounded-2xl px-10 py-3 mb-2 shadow-md shadow-indigo-300">Start generating docs</button>
